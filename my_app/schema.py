...
class UserRegistrationSchema(Schema):
    """This class validates user input for user registration."""

    username = fields.String(
      validate=[validate.Length(min=3), validate.Regexp(
        r'[a-zA-Z0-9_\- ]*$',
...
class UserLoginSchema(Schema):
    """This class validates user input for user login."""
...
class BucketlistSchema(Schema):
    """This class validates user input for bucketlist creation."""

    name = fields.String(validate=[validate.Length(min=3), validate.Regexp(
      r'[a-zA-Z0-9_\- ]*$',
...
class BucketlistItemSchema(Schema):
    """This class validates user input for bucketlist item creation."""
